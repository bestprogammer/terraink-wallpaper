...
IPHONE_PPI = {
    ...
    896:  458,  # iPhone 11 Pro Max, XS Max
    812:  458,  # iPhone X, XS, 11 Pro
...
def get_ppi(screen_height_pts: int) -> int:
    return IPHONE_PPI.get(screen_height_pts, 460)  # 460 als Fallback
...
def main():
    ...
    parser.add_argument("--screen-width",   type=int, default=390,  help="Logische Breite in Punkten")
    parser.add_argument("--screen-height",  type=int, default=844,  help="Logische Höhe in Punkten")
    parser.add_argument("--scale",          type=int, default=3,    help="Scale Factor (2 oder 3)")
